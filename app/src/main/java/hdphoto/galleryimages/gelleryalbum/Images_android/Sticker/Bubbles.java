...
public class Bubbles extends Fragment implements OverClick {
    ...
    private void addsticker(int i) {
        ...
        Duff_CollageActivity.stickerImageView.setOnClickListener(new View.OnClickListener() { // from class: hdphoto.galleryimages.gelleryalbum.android.Sticker.Bubbles.2
            @Override 
    ...
    public void removeBorder() {
        for (int i = 0; i < Duff_CollageActivity.stickerviewId.size(); i++) {
            ...
            if (findViewById instanceof StickerImageView) {
                ((StickerImageView) findViewById).setControlItemsHidden(false);
            }
        }
    }
