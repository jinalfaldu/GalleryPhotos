...
//        this.typeface = Typeface.createFromAsset(this.activity.getAssets(), "fonts/Roboto-Medium.ttf");
        ...
        ((RelativeLayout) dialog.findViewById(R.id.rl_yes)).setOnClickListener(new View.OnClickListener() { // from class: hdphoto.galleryimages.gelleryalbum.android.GalleryModule.GMSorting.GMSortingVideoPrivateDialog.1
            @Override 
            public void onClick(View view) {
                ...
                SortingVideoPrivateDialog.this.Sorting(charSequence, ((RadioButton) radioGroup4.findViewById(radioGroup4.getCheckedRadioButtonId())).getText().toString());
            }
        });
        ((RelativeLayout) dialog.findViewById(R.id.rl_no)).setOnClickListener(new View.OnClickListener() { // from class: hdphoto.galleryimages.gelleryalbum.android.GalleryModule.GMSorting.GMSortingVideoPrivateDialog.2
            @Override 
            public void onClick(View view) {
                dialog.dismiss();
            }
    ...
    public void Sorting(String str, String str2) {
        ...
        try {
            if (str.equals(this.LastModifyDateStr) && str2.equals(this.DescendingStr) && this.imgPathlist.size() > 0 && this.imgPathlist != null) {
                ...
                this.sortingHideVideoCallBack.Sorting(this.imgPathlist);
