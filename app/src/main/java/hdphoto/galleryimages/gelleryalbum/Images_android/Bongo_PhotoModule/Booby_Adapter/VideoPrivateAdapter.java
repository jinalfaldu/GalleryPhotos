...
public class VideoPrivateAdapter extends BaseAdapter {
    Activity activity;
    ...
    public VideoPrivateAdapter(Activity activity, Context context, ArrayList<Object> arrayList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.ly_size = (LinearLayout) view.findViewById(R.id.lin_size);
        ...
        viewHolder.ly_size.setVisibility(View.VISIBLE);
            ...
            public void onClick(View view2) {
                AdInterGD.getInstance().showInter(activity, new AdInterGD.MyCallback() {
                    ...
                    public void callbackCall() {
                        try {
                            if (((DataFileModel) VideoPrivateAdapter.this.arrayList.get(i)).isDirectory) {
                                VideoPrivateAdapter.this.onClickHideListener.onClickListener(((DataFileModel) VideoPrivateAdapter.this.arrayList.get(i)).getSubFile(), Integer.valueOf(i), true, view2);
                            } else {
                                VideoPrivateAdapter.this.onClickHideListener.onClickListener(VideoPrivateAdapter.this.arrayList, Integer.valueOf(i), false, view2);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
        ...
        viewHolder.img_hide_photo_row.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view2) {
                try {
                    if (((DataFileModel) VideoPrivateAdapter.this.arrayList.get(i)).isDirectory) {
                        VideoPrivateAdapter.this.onClickHideListener.onLongClickListener(VideoPrivateAdapter.this.arrayList, Integer.valueOf(i), true, view2);
                    } else {
                        VideoPrivateAdapter.this.onClickHideListener.onLongClickListener(VideoPrivateAdapter.this.arrayList, Integer.valueOf(i), false, view2);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        viewHolder.imgMoreDetail.setOnClickListener(new View.OnClickListener() {
            @Override 
            public void onClick(View view2) {
                VideoPrivateAdapter.this.onClickHideListener.onClickMoreListener(VideoPrivateAdapter.this.arrayList, Integer.valueOf(i), view2, false);
            }
        });
        return view;
    }
