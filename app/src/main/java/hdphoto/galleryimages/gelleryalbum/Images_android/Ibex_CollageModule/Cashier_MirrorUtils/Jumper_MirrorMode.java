...
public class Jumper_MirrorMode {
    public int count;
    ...
    public Jumper_MirrorMode(int i, RectF rectF, RectF rectF2, RectF rectF3, Matrix matrix, int i2, RectF rectF4) {
        Rect rect = new Rect();
    ...
    public Jumper_MirrorMode(int i, RectF rectF, RectF rectF2, RectF rectF3, RectF rectF4, RectF rectF5, Matrix matrix, Matrix matrix2, Matrix matrix3, int i2, RectF rectF6) {
        Rect rect = new Rect();
        this.drawBitmapSrc = rect;
        this.count = i;
        this.srcRect = rectF;
