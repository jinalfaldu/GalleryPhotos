...
public class IImageDeleteAdapter extends BaseAdapter {
    ...
    public IImageDeleteAdapter(Activity activity, Context context, ArrayList<Object> arrayList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.rl_option.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view2) {
                if (IImageDeleteAdapter.this.onClickHideListener != null) {
                    IImageDeleteAdapter.this.onClickHideListener.onClickMoreListener(IImageDeleteAdapter.this.arrayList, Integer.valueOf(i), view2, true);
                } else {
                    Log.e(IImageDeleteAdapter.TAG, "onClick: ");
                }
            }
        });
        viewHolder.img_hide_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view2) {
                try {
                    if (((DataFileModel) IImageDeleteAdapter.this.arrayList.get(i)).isDirectory) {
                        IImageDeleteAdapter.this.onClickHideListener.onClickListener(((DataFileModel) IImageDeleteAdapter.this.arrayList.get(i)).getSubFile(), Integer.valueOf(i), true, view2);
                    } else {
                        IImageDeleteAdapter.this.onClickHideListener.onClickListener(IImageDeleteAdapter.this.arrayList, Integer.valueOf(i), false, view2);
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
        ...
        viewHolder.img_hide_photo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view2) {
                try {
                    if (((DataFileModel) IImageDeleteAdapter.this.arrayList.get(i)).isDirectory) {
                        IImageDeleteAdapter.this.onClickHideListener.onLongClickListener(IImageDeleteAdapter.this.arrayList, Integer.valueOf(i), true, view2);
                    } else {
                        IImageDeleteAdapter.this.onClickHideListener.onLongClickListener(IImageDeleteAdapter.this.arrayList, Integer.valueOf(i), false, view2);
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
        ...
        viewHolder.imgMoreDetail.setOnClickListener(new View.OnClickListener() {
            @Override 
            public void onClick(View view2) {
                IImageDeleteAdapter.this.onClickHideListener.onClickMoreListener(IImageDeleteAdapter.this.arrayList, Integer.valueOf(i), view2, false);
            }
        });
        return view;
    }
    ...
    public void removeitem(ArrayList<Object> arrayList) {
        ...
        this.activity.runOnUiThread(new Runnable() {
            @Override 
            public void run() {
                IImageDeleteAdapter.this.notifyDataSetChanged();
            }
        });
    }
    ...
    public void RemoveItemSingle(String str) {
        for (int i = 0; i < this.arrayList.size(); i++) {
            if (((DataFileModel) this.arrayList.get(i)).path.equals(str)) {
