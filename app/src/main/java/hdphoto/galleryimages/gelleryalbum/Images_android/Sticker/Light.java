...
public class Light extends Fragment implements OverClick {
    ...
    private void addsticker(int i) {
        ...
        Duff_CollageActivity.stickerImageView.setOnClickListener(new View.OnClickListener() { // from class: hdphoto.galleryimages.gelleryalbum.android.Sticker.Light.2
            @Override 
