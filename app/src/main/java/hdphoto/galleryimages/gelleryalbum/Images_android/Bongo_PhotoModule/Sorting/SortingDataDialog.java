...
//        this.typeface = Typeface.createFromAsset(this.activity.getAssets(), "fonts/Roboto-Medium.ttf");
        ...
        ((RelativeLayout) dialog.findViewById(R.id.rl_yes)).setOnClickListener(new View.OnClickListener() { // from class: hdphoto.galleryimages.gelleryalbum.android.GalleryModule.GMSorting.GMSortingDataDialog.1
            @Override 
            public void onClick(View view) {
                ...
                SortingDataDialog.this.Sorting(charSequence, charSequence2);
                Log.d("SSSSSS", " - Sequence -  = nameStr = " + charSequence + " = typeStr = " + charSequence2);
            }
        });
        ((RelativeLayout) dialog.findViewById(R.id.rl_no)).setOnClickListener(new View.OnClickListener() { // from class: hdphoto.galleryimages.gelleryalbum.android.GalleryModule.GMSorting.GMSortingDataDialog.2
            @Override 
            public void onClick(View view) {
                dialog.dismiss();
            }
