...
public class NativeHelper80 {
    ...
    public void shownativeads(Activity activity, final ViewGroup viewGroup) {
        ...
        if (native_gads == null) {
            ...
            try {
                try {
                    new InflatAds80(activity).inflat_admobnativemedium(native_gads, viewGroup);
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void shownativeads1(Activity activity, final ViewGroup viewGroup) {
        ...
        if (native_gads1 == null) {
            ...
            try {
                try {
                    new InflatAds80(activity).inflat_admobnativemedium(native_gads1, viewGroup);
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void shownativeads2(Activity activity, final ViewGroup viewGroup) {
        ...
        if (native_gads2 == null) {
            ...
            try {
                try {
                    new InflatAds80(activity).inflat_admobnativemedium(native_gads2, viewGroup);
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void shownativeads3(Activity activity, final ViewGroup viewGroup) {
        ...
        if (native_gads3 == null) {
            ...
            try {
                try {
                    new InflatAds80(activity).inflat_admobnativemedium(native_gads3, viewGroup);
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                try {
                    if (id == 1) {
                        if (native_gads == null && viewGroup != null) {
                            new InflatAds80(activity).inflat_admobnativemedium(nativeAd, viewGroup);
                        }
