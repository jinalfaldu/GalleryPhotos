...
public class InflatAds80 {
    Context context;


    public InflatAds80(Context context) {
    ...
    public void inflat_admobnativemedium(com.google.android.gms.ads.nativead.NativeAd unifiedNativeAd, ViewGroup viewGroup) {
        ...
        adView = (NativeAdView) ((Activity) context).getLayoutInflater().inflate(R.layout.dic_native_layout_duplicate, null);
